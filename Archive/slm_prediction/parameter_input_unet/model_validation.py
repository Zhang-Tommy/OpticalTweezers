...
B = 1000
model_path = "mlp_model2.pth"
device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")

dataset = HDF5Dataset("./data/validation_data_10_spot.hdf5")
...
# plt.imshow(predicted_mask, cmap='gray')  # Use 'gray' colormap for better visualization
