...
class MLP(nn.Module):
    def __init__(self, input_size=80, hidden_sizes=[512, 1024, 2048], output_size=512 * 512):
...
if __name__ == "__main__":
    ...
    dataset = HDF5Dataset("./data/10_spots_100000_samples.hdf5")
    ...
    model_path = "models/mlp_model_new.pth"
